    ...
    return (
        <div className='max-w-[1320px] mx-auto px-4 2xl:px-0'>
            ...
            {datas.map((data,i) => (
                 ...
                 <div className='font-inter bg-cover bg-center max-w-full h-full xl:pl-20 lg:pl-12  pl-5 flex flex-col  justify-center rounded-md' style={{ backgroundImage: `url(${data.image})` }}  >
